...
export function RestartIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <path d="M3.51 15a9 9 0 105.64-11.36L1 10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
    ...
    >
      <g clipPath="url(#clip0_352_360)">
        ...
        <path
          ...
          stroke="#FF6544"
        />
        <path d="M10 12.1667C10 12.4428 9.77614 12.6667 9.5 12.6667C9.22386 12.6667 9 12.4428 9 12.1667C9 11.8905 9.22386 11.6667 9.5 11.6667C9.77614 11.6667 10 11.8905 10 12.1667Z" fill="#FF6544" />
        <path d="M7 12.1667C7 12.4428 6.77614 12.6667 6.5 12.6667C6.22386 12.6667 6 12.4428 6 12.1667C6 11.8905 6.22386 11.6667 6.5 11.6667C6.77614 11.6667 7 11.8905 7 12.1667Z" fill="#FF6544" />
        <path d="M10 12.1667C10 12.4428 9.77614 12.6667 9.5 12.6667C9.22386 12.6667 9 12.4428 9 12.1667C9 11.8905 9.22386 11.6667 9.5 11.6667C9.77614 11.6667 10 11.8905 10 12.1667Z" fill="#FF6544" />
        <path d="M10 3.83331C10 4.10946 9.77614 4.33331 9.5 4.33331C9.22386 4.33331 9 4.10946 9 3.83331C9 3.55717 9.22386 3.33331 9.5 3.33331C9.77614 3.33331 10 3.55717 10 3.83331Z" fill="#FF6544" />
        <path d="M7 12.1667C7 12.4428 6.77614 12.6667 6.5 12.6667C6.22386 12.6667 6 12.4428 6 12.1667C6 11.8905 6.22386 11.6667 6.5 11.6667C6.77614 11.6667 7 11.8905 7 12.1667Z" fill="#FF6544" />
        <path d="M7 3.83331C7 4.10946 6.77614 4.33331 6.5 4.33331C6.22386 4.33331 6 4.10946 6 3.83331C6 3.55717 6.22386 3.33331 6.5 3.33331C6.77614 3.33331 7 3.55717 7 3.83331Z" fill="#FF6544" />
        <path d="M12.1665 6C12.4426 6 12.6665 6.22386 12.6665 6.5C12.6665 6.77614 12.4426 7 12.1665 7C11.8904 7 11.6665 6.77614 11.6665 6.5C11.6665 6.22386 11.8904 6 12.1665 6Z" fill="#FF6544" />
        <path d="M3.8335 6C4.10964 6 4.3335 6.22386 4.3335 6.5C4.3335 6.77614 4.10964 7 3.8335 7C3.55735 7 3.3335 6.77614 3.3335 6.5C3.3335 6.22386 3.55735 6 3.8335 6Z" fill="#FF6544" />
        <path d="M12.1665 9C12.4426 9 12.6665 9.22386 12.6665 9.5C12.6665 9.77614 12.4426 10 12.1665 10C11.8904 10 11.6665 9.77614 11.6665 9.5C11.6665 9.22386 11.8904 9 12.1665 9Z" fill="#FF6544" />
        <path d="M3.8335 9C4.10964 9 4.3335 9.22386 4.3335 9.5C4.3335 9.77614 4.10964 10 3.8335 10C3.55735 10 3.3335 9.77614 3.3335 9.5C3.3335 9.22386 3.55735 9 3.8335 9Z" fill="#FF6544" />
      </g>
      <defs>
